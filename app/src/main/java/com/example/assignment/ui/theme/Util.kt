...
object Util {
    fun generateSushiItem(): List<Meal> {
        return listOf(
            Meal("Original Sushi", 21.0, 4.8, imageLink = R.drawable.sushi),
            Meal("Shrimp Sushi", 87.0, 4.2, imageLink = R.drawable.sushi),
            Meal("Kaizen Sushi", 201.0, 3.8, imageLink = R.drawable.sushi),
            Meal("Wagyu Sushi", 11.0, 4.4, imageLink = R.drawable.sushi),
            Meal("Mushu Sushi", 27.0, 5.0, imageLink = R.drawable.sushi),
            Meal("Croaker Sushi", 91.0, 2.2, imageLink = R.drawable.sushi),
            Meal("Titus Sushi", 56.0, 4.1, imageLink = R.drawable.sushi),
            Meal("Salmon Sushi", 19.0, 2.0, imageLink = R.drawable.sushi),
        )
    }
